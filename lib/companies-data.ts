...
export const COMPANIES: CompanyTemplate[] = [
  ...
  { name: 'EMS Cayo', slug: 'ems-cayo', category: 'gouvernement', color: '#1a0f0a', accentColor: '#ea580c', description: 'Emergency Medical Services - Cayo Perico' },
