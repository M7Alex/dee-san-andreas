...
export default function LandingPage() {
  // Skip loading screen si on revient du panel admin
  const skipLoading = typeof window !== 'undefined' && new URLSearchParams(window.location.search).has('from')
  const [showLoading, setShowLoading] = useState(!skipLoading)
  const [visible, setVisible] = useState(skipLoading)
